...
</br> 如果传参，则传一个整型值， 找到该编号对应的外设后会打印外设名和描述，
</br> 比如 FPIOA.JTAG_TCLK 或者 fm.fpioa.JTAG_TCLK（fm在本页后面介绍） 或者 0
比如：
...
设置引脚对应的外设功能， 即引脚映射
参数
pin： 引脚编号，取值 [0, 47]， 具体的引脚连接请看电路图， 也可以使用 board_info.
然后按 TAB 按键补全来获得板子的常用引脚，比如 board_info.LED_G
